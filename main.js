...
function hint(){ // Begin hint
    ...
    diff = Math.absolute(guess - currentNumber);
...
{ // Begin processGuess
    ...
    { // If the guess is correct
        ...
        message = `Good job. You wasted your time to get the secret number.`;

        // b) Append on a message that tells them to guess the new number
        message += `Waste more time by guessing the new number.`;
